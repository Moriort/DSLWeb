            ...
            <div className="grid gap-8 md:grid-cols-2 items-center relative z-10">
              <div className="space-y-5">
                <div className="inline-flex items-center rounded-full border border-blue-900/30 bg-blue-900/10 px-3 py-1 text-sm text-blue-400 mb-3">
                  <span>¿Necesitas un proyecto web?</span>
                </div>
                <RevealText className="text-2xl md:text-3xl lg:text-4xl font-bold">
                  Lleva tu presencia online al siguiente nivel
                </RevealText>
                <p className="text-zinc-300 text-base md:text-lg">
                  Nuestro equipo de expertos puede ayudarte a crear soluciones web a medida que potencien tu negocio y mejoren la experiencia de tus usuarios.
                </p>
                ...
                <div className="pt-2">
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2 text-zinc-300">
                      ...
                      <span className="text-sm">Diseños modernos y responsivos</span>
                    </li>
                    <li className="flex items-center gap-2 text-zinc-300">
                      <div className="w-5 h-5 rounded-full bg-blue-900/30 flex items-center justify-center">
                        <ArrowRight className="w-3 h-3 text-blue-400" />
                      </div>
                      <span className="text-sm">Alto rendimiento y experiencia de usuario</span>
                    </li>
                    <li className="flex items-center gap-2 text-zinc-300">
                      <div className="w-5 h-5 rounded-full bg-blue-900/30 flex items-center justify-center">
                        <ArrowRight className="w-3 h-3 text-blue-400" />
                      </div>
                      <span className="text-sm">Tecnologías de vanguardia</span>
                    </li>
                  </ul>
                </div>
              </div>
