...
export default function MetodologiaAndroid() {
  return (
      ...
      <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto text-base md:text-lg">
            Implementamos metodologías ágiles adaptadas específicamente para el desarrollo de aplicaciones Android,
        ...
        >
          <GlassmorphismCard blurIntensity="light" borderColor="blue" className="bg-zinc-900/50 rounded-xl p-8">
            <h3 className="text-xl font-semibold text-white mb-6">Principios de Desarrollo Android</h3>
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                <h4 className="text-blue-400 font-medium mb-2">Arquitectura Sólida</h4>
