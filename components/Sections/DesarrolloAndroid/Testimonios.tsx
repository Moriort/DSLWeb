...
export default function TestimoniosAndroid() {
  const testimonios: Testimonio[] = [
    {
      texto: "La aplicación Android que desarrollaron transformó la gestión de nuestros procesos internos. La interfaz intuitiva y el rendimiento superaron nuestras expectativas.",
      autor: "Carlos Méndez",
      empresa: "TechSolutions SpA",
      calificacion: 5
    },
    {
      texto: "Excelente trabajo en nuestra app Android. El equipo entendió perfectamente nuestras necesidades y entregó una solución móvil que realmente optimiza nuestras operaciones.",
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto text-base md:text-lg">
            Testimonios de empresas que han confiado en nuestras soluciones Android
          </p>
        </motion.div>
