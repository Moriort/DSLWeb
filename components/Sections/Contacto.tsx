              ...
              <div className="relative">
                ...
                <form className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <label className="text-sm font-medium text-zinc-300">Tipo de proyecto</label>
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        { id: "new-app", label: "Nueva aplicación" },
                        { id: "existing-app", label: "Mejora de app existente" },
                        ...
                        <div key={option.id} className="flex items-center space-x-2 group">
                          <input
                            type="checkbox"
                            id={option.id}
                            className="rounded border-zinc-700 text-blue-500 focus:ring-blue-500/50 transition-all duration-300"
                          />
                          <label 
                            htmlFor={option.id} 
                            className="text-sm text-zinc-400 group-hover:text-blue-400 transition-colors cursor-pointer"
                          >
                            {option.label}
                          </label>
                        </div>
                  ...
                  <NeonButton 
                    color="blue" 
                    className="w-full shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 transition-all duration-300"
                  >
